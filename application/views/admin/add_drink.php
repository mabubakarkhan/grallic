	...
	<div class="page-content container-fluid">
      	<div class="panel">
        	<div class="panel-body">
	          	...
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/post-drink/";
			  	else echo BASEURL."admin/update-drink/";
		  		?>">
			  		<?php
					...
					<div class="row row-lg">
		              	...
		              	<div class="form-group form-material col-lg-12 text-right padding-top-m">
	                		<button type="submit" class="btn btn-primary" id="validateButton1">Submit</button> <a class="btn btn-danger waves-effect waves-light" href="<?=BASEURL?>admin/drinks" class="cancel">Cancel</a>
		              	</div><!-- /form-group -->
