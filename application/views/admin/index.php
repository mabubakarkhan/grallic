    ...
    <div class="page-content padding-30 container-fluid">
      <div class="row" data-plugin="matchHeight" data-by-row="true">
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="widget" id="widgetUserList">
            <div class="widget-header cover overlay">
              <img class="cover-image height-200" src="<?=GLOBAL_?>assets//examples/images/dashboard-header.jpg"
              alt="..." />
              ...
              <ul class="list-group list-group-full list-group-dividered">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-lg" href="javascript:void(0)">
                        <img class="img-responsive" src="<?=GLOBAL_?>portraits/1.jpg" alt="...">
                      </a>
                    </div>
                ...
                <li class="list-group-item">
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-lg" href="javascript:void(0)">
                        <img class="img-responsive" src="<?=GLOBAL_?>portraits/2.jpg" alt="...">
                      </a>
                    </div>
                    <div class="media-body">
                ...
                <li class="list-group-item">
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-lg" href="javascript:void(0)">
                        <img class="img-responsive" src="<?=GLOBAL_?>portraits/3.jpg" alt="...">
                      </a>
                    </div>
                    <div class="media-body">
            ...
            <div class="widget-content padding-vertical-20">
              <div class="widget-chat-header">
                ...
                <div class="text-right">
                  ...
                  title="June Lane">
                    <img src="<?=GLOBAL_?>portraits/4.jpg" alt="...">
                  </a>
                </div>
              </div>
              <div class="chats">
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="widget widget-shadow">
            <div class="widget-header cover overlay">
              <div class="cover-background height-200" style="background-image: url('<?=GLOBAL_?>photos/placeholder.png')"></div>
            </div>
            <div class="widget-body padding-horizontal-30 padding-vertical-20" style="height:calc(100% - 250px);">
              <div class="margin-bottom-10" style="margin-top: -70px;">
                <a class="avatar avatar-100 bg-white img-bordered" href="javascript:void(0)">
                  <img src="<?=GLOBAL_?>portraits/2.jpg" alt="">
                </a>
              </div>
