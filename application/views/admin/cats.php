<div class="page animsition">
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a class="btn btn-sm btn-success btn-round" href="<?=BASEURL.'admin/add-cat'?>">
                        ...
                        if (count($cats) > 0) {
                            foreach ($cats as $q): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?=$q['status']?><br>
                                        <select name="status" class="form-control" data-id="<?=$q['category_id']?>">
                                            <option value="">Change Status</option>
                                            <option value="active">Active</option>
                                            <option value="inactive">Inactive</option>
                                        </select>
                                    </td>
                                    <td><a href="<?=BASEURL?>admin/edit-cat/?id=<?=$q['category_id']?>" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row" data-toggle="tooltip" data-original-title="Edit"><i class="icon md-edit" aria-hidden="true"></i></a></td>
                                </tr>
                                <?php endforeach;
                        } //end if
                        else {
