	...
	<div class="page-content container-fluid">
      	<div class="panel">
        	<div class="panel-body">
	          	...
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/update-setting/";
			  	else echo BASEURL."admin/update-setting/";
		  		?>">
					<div class="row row-lg">
						...
						<div class="col-lg-12 form-horizontal">
		                	<div class="example-wrap">
								<div class="form-group form-material">
									<label class="col-lg-12 col-sm-3 control-label">Deliver Charges <span class="required">*</span></label>
									<div class=" col-lg-12 col-sm-9">
										<input type="text" name="delivery_charges" placeholder="Delivery Charges" class="form-control" value="<?=$q['delivery_charges']?>" required>
									</div><!-- /12 -->
								</div><!-- /form-group -->
							</div><!-- /example-wrap -->
		           	...
		           	<div class="row row-lg">
						...
						<div class="col-lg-12 form-horizontal">
		                	<div class="example-wrap">
								<div class="form-group form-material">
									<label class="col-lg-12 col-sm-3 control-label">Pizza Delivery <span class="required">*</span></label>
									<div class=" col-lg-12 col-sm-9">
										<select name="pizza_delivery" class="form-control">
											<?php if ($q['pizza_delivery'] == 'false'): ?>
					...
					<div class="row row-lg">
		              	...
		              	<div class="form-group form-material col-lg-12 text-right padding-top-m">
	                		<button type="submit" class="btn btn-primary" id="validateButton1">Submit</button> <a class="btn btn-danger waves-effect waves-light" href="<?=BASEURL?>admin/setting/" class="cancel">Cancel</a>
		              	</div><!-- /form-group -->
