      	...
      	<div class="panel">
	        ...
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/post-service-box";
			  	else echo BASEURL."admin/update-service-box";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
		                <div class="example-wrap">
							<h4 class="example-title">Icon (67 x 58)</h4>
							<div class="example">
								<input type="file" id="input-file" data-plugin="dropify" required data-default-file="<?=UPLOADS.$q['icon']?>"/>
	              	...
	              	<div class="form-group form-material col-lg-12 text-right padding-top-m">
	                	<button type="submit" class="btn btn-primary" id="validateButton1">Submit</button> <a href="<?=BASEURL.'admin/service-boxs'?>" class="btn btn-danger">Cancel</a>
	              	</div><!-- /form-group -->
	            </div><!-- /row/row-lg -->
	          </form>
	        </div><!-- /panel-body -->
