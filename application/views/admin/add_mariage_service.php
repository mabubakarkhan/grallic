      	...
      	<div class="panel">
	        ...
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/post-mariage-service";
			  	else echo BASEURL."admin/update-mariage-service";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
		                <div class="example-wrap">
							<h4 class="example-title">Image (600 x 400)</h4>
							<div class="example">
	              	...
	              	<div class="form-group form-material col-lg-12 text-right padding-top-m">
	                	<button type="submit" class="btn btn-primary" id="validateButton1">Submit</button> <a href="<?=BASEURL.'admin/mariage-services'?>" class="btn btn-danger">Cancel</a>
	              	</div><!-- /form-group -->
	            </div><!-- /row/row-lg -->
	          </form>
	        </div><!-- /panel-body -->
