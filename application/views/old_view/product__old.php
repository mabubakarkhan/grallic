						...
						<?php if ($product['deal'] == 'yes'): ?>
							<select name="drink">
								...
								<?php foreach ($drinks as $key => $drink): ?>
									<option value="<?=$drink['title']?>"><?=$drink['title']?></option>
								<?php endforeach ?>
							</select>
						<?php else: ?>
							<?php if ($drinks): ?>
								<select name="drink">
									<option value="">Select Cold Drink</option>
									<?php foreach ($drinks as $key => $drink): ?>
										<option value="<?=$drink['drink_id']?>" data-price="<?=$drink['price']?>"><?=$drink['title']?> (<?=$drink['price']?>)</option>
									<?php endforeach ?>
								</select>
							<?php endif ?>
						<?php endif ?>
						<?php if ($addons): ?>
							<select name="addon">
								...
								<?php foreach ($addons as $key => $addon): ?>
									<option value="<?=$addon['addon_id']?>" data-price="<?=$addon['price']?>"><?=$addon['title']?> (<?=$addon['price']?>)</option>
								<?php endforeach ?>
							</select>
						<?php endif ?>
					<?php endif ?>
